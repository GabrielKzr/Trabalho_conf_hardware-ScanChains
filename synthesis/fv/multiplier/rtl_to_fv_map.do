...
# Generated on: Thu Jun 11 19:57:05 -03 2026 (Thu Jun 11 22:57:05 UTC 2026)
...
set logfile fv/multiplier/rtl_to_fv_map.log
...
read_implementation_information fv/multiplier -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../rtl/multiplier.sv
elaborate_design -golden -root {multiplier} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/multiplier/fv_map.v.gz
elaborate_design -revised -root {multiplier}
...
#add_name_alias fv/multiplier/fv_map.singlebit.original_name.alias.json.gz -revised
