...
# Generated on: Thu Jun 11 20:52:01 -03 2026 (Thu Jun 11 23:52:01 UTC 2026)
...
set logfile fv/multiplier_param_N64/rtl_to_fv_map.log
...
read_implementation_information fv/multiplier_param_N64 -revised fv_map
...
elaborate_design -golden -root {multiplier_param} -rootonly -rootonly  -parameter -int {N} "32'sh00000040"

read_design -verilog95   -revised -lastmod -noelab fv/multiplier_param_N64/fv_map.v.gz
elaborate_design -revised -root {multiplier_param_N64}
...
#add_name_alias fv/multiplier_param_N64/fv_map.singlebit.original_name.alias.json.gz -revised
