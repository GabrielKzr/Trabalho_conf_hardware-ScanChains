...
# Generated on: Tue Jun 16 20:15:53 -03 2026 (Tue Jun 16 23:15:53 UTC 2026)
...
set logfile fv/multiplier_param_N128/rtl_to_fv_map.log
...
read_implementation_information fv/multiplier_param_N128 -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/soft64/cadence/ferramentas/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/soft64/cadence/ferramentas/GENUS211/tools.lnx86"
set env(CW_DIR) "/soft64/cadence/ferramentas/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/soft64/cadence/ferramentas/GENUS211/tools.lnx86/lib/chipware"
...
add_search_path . /soft64/cadence/ferramentas/GENUS211/tools.lnx86/lib/tech -library -both
read_library -liberty -both \
    /soft64/design-kits/stm/65nm-cmos065_536/CORE65GPSVT_5.1/libs/CORE65GPSVT_nom_1.00V_25C.lib \
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../rtl/multiplier_param.sv
elaborate_design -golden -root {multiplier_param} -rootonly -rootonly  -parameter -int {N} "32'sh00000080"

read_design -verilog95   -revised -lastmod -noelab fv/multiplier_param_N128/fv_map.v.gz
elaborate_design -revised -root {multiplier_param_N128}
...
#add_name_alias fv/multiplier_param_N128/fv_map.singlebit.original_name.alias.json.gz -revised
