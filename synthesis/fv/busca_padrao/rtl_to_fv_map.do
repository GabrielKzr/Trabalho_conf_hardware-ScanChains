...
# Generated on: Tue Jun 02 19:38:57 -03 2026 (Tue Jun 02 22:38:57 UTC 2026)
...
set logfile fv/busca_padrao/rtl_to_fv_map.log
...
read_implementation_information fv/busca_padrao -revised fv_map
...
read_design -rangeconstraint -configuration  -enumconstraint -golden -lastmod -noelab  -vhdl 93  ../rtl/busca_padrao.vhd
elaborate_design -golden -root {busca_padrao} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/busca_padrao/fv_map.v.gz
elaborate_design -revised -root {busca_padrao}
...
#add_name_alias fv/busca_padrao/fv_map.singlebit.original_name.alias.json.gz -revised
