...
# Generated on: Tue Jun 02 20:20:10 -03 2026 (Tue Jun 02 23:20:10 UTC 2026)
...
set logfile fv/alu_core/rtl_to_fv_map.log
...
read_implementation_information fv/alu_core -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../rtl/alu_core.sv
elaborate_design -golden -root {alu_core} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/alu_core/fv_map.v.gz
elaborate_design -revised -root {alu_core}
