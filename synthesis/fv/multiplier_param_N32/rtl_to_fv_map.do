...
# Generated on: Tue Jun 16 20:13:11 -03 2026 (Tue Jun 16 23:13:11 UTC 2026)
...
set logfile fv/multiplier_param_N32/rtl_to_fv_map.log
...
read_implementation_information fv/multiplier_param_N32 -revised fv_map
...
elaborate_design -golden -root {multiplier_param} -rootonly -rootonly  -parameter -int {N} "32'sh00000020"

read_design -verilog95   -revised -lastmod -noelab fv/multiplier_param_N32/fv_map.v.gz
elaborate_design -revised -root {multiplier_param_N32}
...
#add_name_alias fv/multiplier_param_N32/fv_map.singlebit.original_name.alias.json.gz -revised
