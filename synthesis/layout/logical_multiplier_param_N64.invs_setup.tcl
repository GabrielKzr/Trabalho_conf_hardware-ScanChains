...
source layout/logical_multiplier_param_N64.flowkit_settings.tcl

source layout/logical_multiplier_param_N64.invs_init.tcl

# Reading metrics file
################################################################################
read_metric -id current layout/logical_multiplier_param_N64.metrics.json
## Reading Innovus Mode attributes file
pqos_eval {rcp::read_taf layout/logical_multiplier_param_N64.mode_attributes.taf.gz}

## Reading common preserve file for dont_touch and dont_use preserve settings
source -quiet layout/logical_multiplier_param_N64.preserve.tcl

read_def /home/gabriel.kaizer/Downloads/testa_padrao_scan/synthesis/layout/logical_multiplier_param_N64.scan.def.gz


# Mode Setup
################################################################################
source layout/logical_multiplier_param_N64.mode
...
################################################################################
      ...
      if { [is_attribute -obj_type port original_name] &&
        ...
        source layout/logical_multiplier_param_N64.wnm_attrs.tcl
      }
    

# Reading NDR file
source layout/logical_multiplier_param_N64.ndr.tcl

# Reading Instance Attributes file
pqos_eval { rcp::read_taf layout/logical_multiplier_param_N64.inst_attributes.taf.gz}

# Reading minimum routing layer data file
################################################################################
eval_legacy {gpsPrivate::readMinLayerCstr -file layout/logical_multiplier_param_N64.min_layer} 
