...
################################################################################
if {[::legacy::find -design design:multiplier_param] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj design:multiplier_param
}
...
# Design
################################################################################
read_netlist -top multiplier_param layout/logical_multiplier_param.v.gz
read_metric -id current layout/logical_multiplier_param.metrics.json

phys::read_script layout/logical_multiplier_param.g.gz
...
# slack
set _slk_ [::legacy::get_attribute slack design:multiplier_param]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns design:multiplier_param]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area design:multiplier_param]
...
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area design:multiplier_param]
