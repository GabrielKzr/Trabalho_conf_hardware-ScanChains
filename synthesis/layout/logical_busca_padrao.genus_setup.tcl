...
# Design
################################################################################
read_netlist -top busca_padrao layout/logical_busca_padrao.v.gz
read_metric -id current layout/logical_busca_padrao.metrics.json

phys::read_script layout/logical_busca_padrao.g.gz
...
if {$_cell_area_ != "3868"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 3868,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "2152"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 2152,  current net area: $_net_area_"
}
unset _net_area_
