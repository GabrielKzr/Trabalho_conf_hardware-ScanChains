...
source layout/logical_multiplier.flowkit_settings.tcl

source layout/logical_multiplier.invs_init.tcl

# Reading metrics file
################################################################################
read_metric -id current layout/logical_multiplier.metrics.json
## Reading Innovus Mode attributes file
pqos_eval {rcp::read_taf layout/logical_multiplier.mode_attributes.taf.gz}

## Reading common preserve file for dont_touch and dont_use preserve settings
source -quiet layout/logical_multiplier.preserve.tcl

read_def /home/gabriel.kaizer/Downloads/testa_padrao_scan/synthesis/layout/logical_multiplier.scan.def.gz


# Mode Setup
################################################################################
source layout/logical_multiplier.mode
...
################################################################################
      ...
      if { [is_attribute -obj_type port original_name] &&
        ...
        source layout/logical_multiplier.wnm_attrs.tcl
      }
    

# Reading NDR file
source layout/logical_multiplier.ndr.tcl

# Reading Instance Attributes file
pqos_eval { rcp::read_taf layout/logical_multiplier.inst_attributes.taf.gz}

# Reading minimum routing layer data file
################################################################################
eval_legacy {gpsPrivate::readMinLayerCstr -file layout/logical_multiplier.min_layer} 
