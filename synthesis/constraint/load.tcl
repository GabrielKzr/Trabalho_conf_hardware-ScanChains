...
set _REPORTS_PATH ${_OUTPUTS_PATH}/reports
set _DFT_PATH ${_OUTPUTS_PATH}/dft
set _LOG_PATH ${_OUTPUTS_PATH}/logs
...
## Used to avoid error on SDF read
...
# used for gate level verification
set LIB_FILES "${DK_PATH}/CORE65GPSVT_5.1/behaviour/verilog/CORE65GPSVT.v ${DK_PATH}/CLOCK65GPSVT_3.1/behaviour/verilog/CLOCK65GPSVT.v \
${DK_PATH}/IO65LPHVT_SF_1V8_50A_7M4X0Y2Z_7.0/behaviour/verilog/IO65LPHVT_SF_1V8_50A_7M4X0Y2Z.v"
