...
build_model \
    ...
    -designsource	 $WORKDIR/multiplier_param_N16.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/multiplier_param_N16.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 multiplier_param_N16_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_multiplier_param_N16_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 multiplier_param_N16_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_multiplier_param_N16_atpg
...
check_log log_commit_tests_FULLSCAN_multiplier_param_N16_atpg
